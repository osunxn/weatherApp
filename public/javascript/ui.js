...
<div class="toggle">
    <p>Map</p>
    <div class="togglebox">
        <span id="3Dmap" class="active">3D</span>
        <span id="2Dmap" class="active">2D</span>
    </div>
</div>
...
const moreNavbar = document.querySelector('.moreNavigation');
const moreNavigation = document.createElement('div');

moreNavigation.innerHTML = `
<div class="conversion-options">
  <div class="kmNmile">
      <span id="km">km</span>
      <span id="mile">miles</span>
  </div>
  <div class="mphNkph">
      <span id="m/h">m/h</span>
...
moreNavbar.appendChild(moreNavigation);

const temperatureToggle = document.querySelector('.temperature-toggle');

// Function to show conversion options and update styles
function showConversionOptions() {
    moreNavbar.style.display = 'block';
    temperatureToggle.style.borderBottomLeftRadius = '0px';
    temperatureToggle.style.borderBottomRightRadius = '0px';
}

// Function to hide conversion options and update styles
function hideConversionOptions() {
    moreNavbar.style.display = 'none';
    temperatureToggle.style.borderBottomLeftRadius = '5px';
    temperatureToggle.style.borderBottomRightRadius = '5px';
}

// Add event listeners for mouseover and mouseout on the entire unit-toggles container
// Add event listeners for mouseover and mouseout
temperatureToggle.addEventListener('mouseover', showConversionOptions);
moreNavbar.addEventListener('mouseover', showConversionOptions);

temperatureToggle.addEventListener('mouseout', hideConversionOptions);
moreNavbar.addEventListener('mouseout', hideConversionOptions);
...
<div class="footermain">
    <div class="cuservice">
        ...
        <h3>Account</h3>
        <ul class="list-unstyled">
            <li><a href="#" rel="noopener">Account Setting</a></li>
